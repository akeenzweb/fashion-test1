<template>
  <div class="home">
    ...
    <!--<MobileConsole></MobileConsole>-->
          ...
          <h2 class="find-your"><b>Find your</b> match style!</h2>

          <div class="row">
            <ul class="category">
              <li class="active-btn">Trends</li>
              <li>2021 New</li>
              <li>Trends</li>
              <li>2021 New</li>
              <li>Trends</li>
...
.search:focus {
  ...
  padding-left: 15px;
  outline: none;
  border: 1px solid rgb(245, 212, 27);
  transition: all ease 0.4s;
}
.find-your {
  font-family: 'Euclid Circular A';
